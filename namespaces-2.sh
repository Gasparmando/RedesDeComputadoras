...
tap1B="2001:aaaa:aaaa:1::1A"
brtap1b="2001:aaaa:aaaa:1::A1"
br="2001:cccc:cccc:1::A"



tap12="2001:bbbb:1111:1::12"
tap21="2001:bbbb:1111:1::21"

tap13="2001:bbbb:2222:1::13"
tap31="2001:bbbb:2222:1::31"

tap14="2001:bbbb:3333:1::14"
tap41="2001:bbbb:3333:1::41"

tap34="2001:bbbb:6666:1::34"
tap43="2001:bbbb:6666:1::43"

tap35="2001:bbbb:4444:1::35"
tap53="2001:bbbb:4444:1::53"
...
ip netns exec $NS1 ip -6 route add default via $brtap1b
...
ip netns exec $NS1 ip -6 route add 2001:bbbb:4444:1::/64 dev tap13 via 2001:bbbb:2222:1::31
ip netns exec $NS1 ip -6 route add 2001:bbbb:5555:1::/64 dev tap14 via 2001:bbbb:3333:1::41
ip netns exec $NS1 ip -6 route add 2001:bbbb:6666:1::/64 dev tap13 via 2001:bbbb:2222:1::31

ip netns exec $NS2 ip -6 route add default via $tap12

ip netns exec $NS3 ip -6 route add default via $tap13
ip netns exec $NS3 ip -6 route add 2001:bbbb:5555:1::/64 dev tap34 via 2001:bbbb:6666:1::43

ip netns exec $NS4 ip -6 route add default via $tap14
ip netns exec $NS4 ip -6 route add 2001:bbbb:4444:1::/64 dev tap43 via 2001:bbbb:6666:1::34
